...
// Example teacher's schedule events
const teacherEvents = [
  {
  ...
  {
    title: "Science Lab - Grade 7",
    start: new Date(2024, 11, 26, 14, 0, 0),
    end: new Date(2024, 11, 26, 15, 30, 0),
  },
];
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="flex-1 flex gap-4 justify-between flex-wrap">
            ...
            <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%]">
              ...
              <div>
                <h1 className="text-xl font-semibold">{`Batches: ${["Batch A", "Batch B"].join(", ")}`}</h1>
